    ...
    <div className="relative p-8 rounded-2xl bg-[#0c0c0e]/60 border border-zinc-800/80 backdrop-blur-xl shadow-2xl shadow-black/50 space-y-6 overflow-hidden ring-1 ring-white/[0.02]">
      ...
      <div className="space-y-1.5 relative z-10">
        ...
        <p className="text-sm text-zinc-400">
          Sign in to access your generative engine control panel.
        </p>
      </div>
            ...
            <Field data-invalid={fieldState.invalid}>
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs font-semibold text-purple-400 hover:text-purple-300 transition-colors underline-offset-4 hover:underline"
                >
                  Forgot key?
                </Link>
              </div>
      ...
      <div className="relative flex items-center justify-center my-5 relative z-10">
        ...
        <span className="relative bg-[#0c0c0e] px-3 text-[10px] uppercase tracking-widest text-zinc-500 select-none与 card color consistent">
          Or pipeline through
        </span>
      </div>
